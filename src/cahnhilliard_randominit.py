    ...
    def run(self):
        ...
        for i in range(tsteps):
            ...
            if i % dump == 0:
                ...
                plt.savefig('./t'+image_num+'.png', dpi=300)
                plt.clf()
...
'dt' : 0.0004, # timestep size
'tsteps' : 150001, # number of timesteps
'tol' : 1e-5, # convergence criterion for implicit methods (not used for explicit)

'dump' : 7500, # dump an image every 'dump' steps
...
'spatial_method' : 'spectral', # Choice of 2CD, 4CD
